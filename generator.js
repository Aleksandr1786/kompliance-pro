...
async function generatePackage(client,settings,outputDir,scope='ALL'){
  ...
  // Журнал контроля аптечки — отдельный документ (сессия 07.07.2026,
  // повторно восстановлено 14.07.2026 после потери в незакоммиченном
  // хвосте файлов): ведётся поквартально, поэтому идёт в d6 (Журналы
  // учёта), как и остальные журналы, а не рядом с инструкцией в d5.
  await run(p2.gen_05_08_journal,dirs.d6);
