...
async function gen_vu_02(c, s, dir) {
  ...
  const ch = [
    ...
    bul('Поддерживать в актуальном состоянии сведения о военнообязанных работниках в карточках гражданина, подлежащего воинскому учёту (форма № 10).'),
    ...
    bul(`В течение 5 дней направлять в ${voenkomat(vu)} сведения о приёме на работу военнообязанных.`),
    bul(`В течение 5 дней направлять в ${voenkomat(vu)} сведения об увольнении военнообязанных.`),
    bul('При изменении сведений о семейном положении, образовании, должности, месте жительства вносить изменения в карточки в течение 5 дней.'),
    ...eL(1),
...
async function gen_vu_03(c, s, dir) {
  ...
  const mainRows = [
    ...
    mk(num(), 'Направление в военный комиссариат сведений о принятых на работу и уволенных с работы граждан, пребывающих в запасе, а также об изменениях их данных воинского учёта', 'В течение 5 дней', resp),
...
// Подаётся в военкомат в течение 5 дней от даты подписания приказа
