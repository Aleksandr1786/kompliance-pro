      ...
      <div style="flex:1;display:flex;flex-direction:column;gap:14px">
        ...
        <div class="section" id="s-tg">
          ...
          <div class="section-body">
            ...
            <div class="toggle-row"><div class="toggle-info"><div class="toggle-label">Общая лента по охране труда</div><div class="toggle-desc">Региональные документы и широкие новости ОТ — без Telegram, только в ленте приложения</div></div><label class="toggle"><input type="checkbox" ${s.npa_general_feed!=='0'?'checked':''} onchange="saveSetting('npa_general_feed',this.checked?'1':'0')"><span class="toggle-slider"></span></label></div>
