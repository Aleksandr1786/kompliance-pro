...
const SECTIONS = {
  OT: [
    ...
    { id:'OT_CHOP',      order:8, folder:'Раздел 8. ЧОП',                                          title:'ЧОП',                   icon:'shield' },
...
const FILE_SECTION = {
  ...
  // Раздел 8. ЧОП (аддон CHOP)
  'Приказ об утверждении табеля постов охраны.docx': 'OT_CHOP',
  'Приказ о допуске к оружию и специальным средствам.docx': 'OT_CHOP',
...
const SECTION_PATTERNS = [
  ...
  // Раздел 8 ОТ (ЧОП) — инструкции охраннику по типу поста (динамическое имя)
  { test: n => n.startsWith('Инструкция охраннику поста'), section: 'OT_CHOP' },
];
